...
class Question
{
    ...
    {
        if (!is_numeric($id)) {
            throw new Exception('qid '._MD_XQUIZ_AM_XQUIZ_QUEST_NUMBER_ERROR);
        }
        $this->qid = $id;
    }
    ...
    public function set_qnumber($qnumber)
    {
        if (!is_numeric($qnumber)) {
            throw new Exception(_MD_XQUIZ_AM_XQUIZ_QUEST_NUMBER_ERROR);
        }
    ...
    {
        global $xoopsDB;
        $result = $xoopsDB->query("SELECT * FROM " . $xoopsDB->prefix('xquiz_questionsx')." WHERE qid = $qId");
    ...
    public static function question_listQuestionLoader($eu, $limit, $qid)
    {
        ...
        $listQuiz = [];
        $q=1;
        $query = $xoopsDB->query(' SELECT * FROM ' . $xoopsDB->prefix('xquiz_questionsx').
    ...
    {
        global $xoopsDB;
        $query =$xoopsDB->query("SELECT * FROM ". $xoopsDB->prefix('xquiz_questionsx') ." WHERE id = '$eId'");
    ...
    public static function QuestForm($qId, $op="add", $eId = 0)
    {
        ...
        if ("edit" == $op) {
            ...
            $question_number = new XoopsFormText(_MD_XQUIZ_AM_XQUIZ_QUEST_NUMBER, "questionNumber", 5, 3, $question_qnumber_v);
    ...
    public function addQuestion()
    {
        ...
        global $xoopsDB;
        $query = "Insert into ".$xoopsDB->prefix("xquiz_questionsx")."
    ...
    {
        global $xoopsDB;
        $query = "UPDATE ".$xoopsDB->prefix("xquiz_questionsx")." SET 
					  qid = '$this->qid'
    ...
    {
        global $xoopsDB;
        $query = $xoopsDB->query("SELECT COUNT(qid) AS CID FROM ".$xoopsDB->prefix("xquiz_questionsx")." WHERE qid = '$quizId'");
        $myrow = $xoopsDB->fetchArray($query);
        return  $myrow['CID'];
    }
    #endregion
    ...
    public static function listQuestLoader($qId)
    {
        ...
        $listQuest = [];
        $q=1;
        $query = $xoopsDB->query(" SELECT * FROM " . $xoopsDB->prefix('xquiz_questionsx')." WHERE qid = '$qId' ORDER BY 'qnumber' ASC");
        while ($myrow = $xoopsDB->fetchArray($query)) {
