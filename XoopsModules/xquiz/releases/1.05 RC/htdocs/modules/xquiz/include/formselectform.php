 ...
 * @access 		public
 */
class XQuizFormSelectForm extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XQuizFormSelectForm($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $form_id_handler = xoops_getmodulehandler('forms_id', 'xquiz');
        $criteria = new Criteria(1,1);
        $criteria->setSort('`title`');
        
		foreach($form_id_handler->getObjects($criteria, true) as $form_id_id => $item)
			$this->addOption($form_id_id, $item->getVar('title'));
    }
