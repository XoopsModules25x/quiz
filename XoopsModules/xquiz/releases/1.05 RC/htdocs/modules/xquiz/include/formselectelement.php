 ...
 * @access 		public
 */
class XQuizFormSelectElement extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XQuizFormSelectElement($caption, $name, $value = null, $size = 1, $multiple = false, $id_form = 0, $none = false)
    {
        ...
        $criteria->setSort('`ele_caption`');
        
		foreach($forms_handler->getObjects($criteria, true) as $ele_id => $item)
			$this->addOption($ele_id, $item->getVar('ele_caption'));
    }
